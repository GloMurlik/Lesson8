package ru.mirea.gribinichenko.yandexdriver;
...
import ru.mirea.gribinichenko.yandexdriver.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ru.mirea.gribinichenko.yandexdriver.databinding.ActivityMainBinding binding = ActivityMainBinding.inflate(getLayoutInflater());
    ...
    private void showMarkerInfo() {
        Toast.makeText(getApplicationContext(), "Музей Японских автомобилей Buckets Empire" +
